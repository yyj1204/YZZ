...
public class ViewHolder {
	 ...
	 *  隐藏TextView
	 * **/
	public ViewHolder setTextisShow(int viewId,int type)
	{
		TextView view=getView(viewId);
	 ...
	 * **/
	public ViewHolder setImageResource(int viewId,int loadingimgID,String url)
	{
		ImageView img=getView(viewId);
		GlideUtils.loadImage(context,url,loadingimgID,img);
		return this;
	}
	/***
	 *  隐藏ImageView
