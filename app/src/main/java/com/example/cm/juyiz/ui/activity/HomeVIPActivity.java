...
//                Intent intent = new Intent(VIPActivity.this, DetailsActivity.class);
//                intent.putExtra(MyConstant.KEY_MIAN_FRAGMENT,MyConstant.VALUE_OTHER);
        ...
        public void OnClick(View view){
            switch (view.getId())
            {
                ...
                case R.id.iv_vip_banner://广告
                    myUtils.showToast(this,"这是会员专享的广告");
                    break;
                default:
                    break;
        }
